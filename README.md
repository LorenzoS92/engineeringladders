...
* [**Engineering Manager & Tech Lead**](EngineeringManager.md): role also known as dev manager or tech leader, is responsible for the consistent delivery, career growth and level of happiness of the team, and about the technical architecture

If you are confused about the difference between a [Tech Lead](TechLead.md) and an [Engineering Manager](EngineeringManager.md), please refer to the [Engineering Manager](EngineeringManager.md) page.

| Level | Senior | Role
| :---: | :---: | :---:
| 1 | No | [Associate Engineer](Developer.md#d1---developer-1)
| 3 | No | [Engineer](Developer.md#d3---developer-3)
| 5 | Yes | [Senior Software Engineer](Developer.md#d5---developer-5) 
| 4 | Yes | [Staff Software Engineer](Developer.md#d7---developer-7)
| 5 | Yes | [Tech Leader](EngineeringManager.md)
| 6 | Yes | [Engineering Manager](EngineeringManager.md)
